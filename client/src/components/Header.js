  ...
  return (
    <header className="bg-primary py-6 fixed w-full top-0 z-40 lg:relative xl:mb-[30px]">
      <div className="container mx-auto">
        <div className="flex flex-row gap-4 lg:items-center justify-between items-center mb-4 xl:mb-0">
          {/* menu */}
          <div
          ...
          <div
            ...
            } fixed top-0 bottom-0 z-30 w-full h-screen transition-all duration-500`}>
          ...
          <div className="flex items-center gap-[10px]">
            ...
            <div
              ...
              bg-[#0e0f10] shadow-xl fixed top-0 bottom-0 w-full z-10 md:max-w-[500px] transition-all duration-500`}>
              <Cart />
            </div>
          </div>
        </div>
